...
//                contract.setPlayer(entityManager.find(Player.class,i));
//                contract.setSeason(entityManager.find(Season.class,1L));
//                contract.setSeasonSalary(fake.number().randomDouble(2,100_000_000,200_000_000));
